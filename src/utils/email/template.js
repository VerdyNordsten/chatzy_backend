...
<head>
  ...
  <meta name="keywords" content="Chatzy, Javascript, NodeJS, ExpressJS">
...
<body style="background-color: #00AAFF; padding: 20px;">
  <h1 class="auth-title">
    Chatzy
  </h1>

  <div class="auth-content" style="background-color: white;">
    <p style="font-size: 20px;">Halo, Welcome to Chatzy</p>
